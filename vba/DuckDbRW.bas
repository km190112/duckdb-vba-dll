Attribute VB_Name = "DuckDbRW"
'==============================================================================
' DuckDbRW - DuckDB アクセスモジュール【② 読み書き可】
'
' 対象 DLL   : duckdb_rw.dll
...
Private Const DLL_NAME As String = "duckdb_rw.dll"
...
Private Declare PtrSafe Function DackVersionRaw Lib "duckdb_rw.dll" Alias "DackVersion" ( _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCapabilitiesRaw Lib "duckdb_rw.dll" Alias "DackCapabilities" ( _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackOpen Lib "duckdb_rw.dll" ( _
    ByVal pathPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackClose Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackQuery Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackQueryParams Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef params As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackListTables Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackDescribe Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal tablePtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecute Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecuteParams Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef params As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackAppendArray Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal tablePtr As LongPtr, ByRef data As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackBegin Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCommit Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackRollback Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCreateDatabase Lib "duckdb_rw.dll" ( _
    ByVal pathPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecuteDDL Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExportSchema Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByVal formatPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCheckpoint Lib "duckdb_rw.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long
...
Public Sub DuckDbInit(ByVal dllFolder As String)
    ...
    If Dir$(fullPath) = "" Then
        Err.Raise ERR_BASE, "DuckDbRW", "DLL が見つかりません: " & fullPath
    End If
...
Private Sub Check(ByVal rc As Long, ByRef result As Variant, ByVal funcName As String)
    ...
    Err.Raise ERR_BASE + Abs(rc), "DuckDbRW." & funcName, msg
End Sub
