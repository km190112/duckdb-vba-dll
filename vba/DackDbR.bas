Attribute VB_Name = "DackDbR"
'==============================================================================
' DackDbR - DuckDB アクセスモジュール【① 読み取り専用】
'
' 対象 DLL   : dackdb_r.dll
' できること : SELECT のみ
...
Private Const DLL_NAME As String = "dackdb_r.dll"
...
Private Declare PtrSafe Function DackVersionRaw Lib "dackdb_r.dll" Alias "DackVersion" ( _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCapabilitiesRaw Lib "dackdb_r.dll" Alias "DackCapabilities" ( _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackOpen Lib "dackdb_r.dll" ( _
    ByVal pathPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackClose Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackQuery Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackQueryParams Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef params As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackListTables Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackDescribe Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal tablePtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecute Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecuteParams Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef params As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackAppendArray Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal tablePtr As LongPtr, ByRef data As Variant, _
    ByRef result As Variant) As Long

Private Declare PtrSafe Function DackBegin Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCommit Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackRollback Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCreateDatabase Lib "dackdb_r.dll" ( _
    ByVal pathPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExecuteDDL Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal sqlPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackExportSchema Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByVal formatPtr As LongPtr, ByRef result As Variant) As Long

Private Declare PtrSafe Function DackCheckpoint Lib "dackdb_r.dll" ( _
    ByVal handle As LongLong, ByRef result As Variant) As Long
...
Public Sub DackDbInit(ByVal dllFolder As String)
    ...
    If Dir$(fullPath) = "" Then
        Err.Raise ERR_BASE, "DackDbR", "DLL が見つかりません: " & fullPath
    End If
...
' 使うには DackDbRW モジュール + dackdb_rw.dll に切り替えてください。
...
Private Sub Check(ByVal rc As Long, ByRef result As Variant, ByVal funcName As String)
    ...
    Err.Raise ERR_BASE + Abs(rc), "DackDbR." & funcName, msg
End Sub
